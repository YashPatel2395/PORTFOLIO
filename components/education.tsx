      ...
      <div className="section-container relative z-10">
        <div className="flex items-center gap-6 mb-20">
          ...
          <div className="relative group">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-center tracking-tight relative">Education</h2>
        ...
        <div className="space-y-16">
          {education.map((edu, index) => (
            <div key={index} className="relative">
              ...
              <Card className="p-8 sm:p-10 md:p-14 hover:shadow-2xl transition-all duration-500 border-2 hover:border-foreground/40 group relative overflow-hidden bg-background/50 backdrop-blur-sm">
                  ...
                  <div className="mb-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-base text-muted-foreground">
                      <div className="space-y-2">
                        <p className="font-bold text-foreground text-lg">{edu.institution}</p>
                        <p className="font-medium text-base">{edu.location}</p>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h4 className="font-bold mb-6 text-lg flex items-center gap-3">
